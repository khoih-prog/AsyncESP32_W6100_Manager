...
void setup()
{
  ...
  AsyncESP32_W6100_Manager AsyncESP32_W6100_manager(&webServer, NULL, "AsyncCP-ParamsOnSW");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_W6100_Manager AsyncESP32_W6100_manager(&webServer, &dnsServer, "AsyncCP-ParamsOnSW");
#endif
