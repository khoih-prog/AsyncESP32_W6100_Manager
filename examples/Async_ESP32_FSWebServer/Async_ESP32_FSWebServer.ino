...
void setup()
{
  ...
  AsyncESP32_W6100_Manager AsyncESP32_W6100_manager(&server, NULL, "AsyncESP32-FSWebServer");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_W6100_Manager AsyncESP32_W6100_manager(&server, &dnsServer, "AsyncESP32-FSWebServer");
#endif
